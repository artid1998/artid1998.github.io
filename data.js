...
const portfolioData = [
  ...
  },
  {
    category: "사무실",
    title: "한국메인라인",
    desc: "첫 시작시 라쿠라쿠 모드로 시작용인시 OOO 고급맨션단지 공용부 창고를 리모델링 했습니다. 지하 주차장 옆 빈 창고(건설 당시 창고) 공간을 주거자 서비스 공간으로 리모델링 하여 거주자의 정착율 높이기 위해, 목적이나 기분으로 이용할 수 있는 공간,  장시간 장소에 구애받지 않고 인터넷이나 기타 통신기기를 개인적으로 사용할 수 있는 공간확보, 그룹으로도 이용 할 수 있는 주민의 편의 시설을 만들어 주는 공사였습니다.",
